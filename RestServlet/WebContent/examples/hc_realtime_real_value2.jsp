	                        ...
	                        setInterval(function() {
	                        	...
	                        	$.get(loadUrl,
		            			    ...
		            			    function(responseText){
		            					...
		            					//se il client arduino si è fermato, anzichè mostrare gli ultimi N valori a ripetizione, mostro solo l'ultimo a ripetizione
		            					else if(!newPoints && responseText.length > 0){
	        	                            var x = responseText[responseText.length - 1].timestamp,
	        	                            y = responseText[responseText.length - 1].value;
	        	                            series.addPoint([x, y], true, true);
		            					}
