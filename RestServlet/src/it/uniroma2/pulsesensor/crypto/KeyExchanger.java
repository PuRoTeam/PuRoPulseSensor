...
import it.uniroma2.pulsesensor.servlet.ArduinoShared;
import it.uniroma2.pulsesensor.servlet.ShareTime;
import it.uniroma2.pulsesensor.servlet.Shared;
...
public class KeyExchanger implements Runnable
{
	...
	public void run() 
	{
		try
		{
			...
			System.out.println("Connessione instaurata con " + clientIP);
	        ...
	        System.out.println("Diffie Hellman Exchange");
	        ...
	        System.out.println("Initial Timestamp Agreement");
